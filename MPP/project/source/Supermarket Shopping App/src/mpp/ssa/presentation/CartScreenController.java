 ...
 */
public class CartScreenController extends Controller{
    ...
    public void createCartPane(){
        try {
            CartPane = FXMLLoader.load(getClass().getResource("cart_screen.fxml"));
    ...
    public void handleCheckout(ActionEvent event){
        ...
        CheckoutScreenController checkoutScreenController = new CheckoutScreenController();
